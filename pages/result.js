...
import {Center, Heading, Link, useColorMode} from "@chakra-ui/react"
...
return (
<Center><Heading>{`Yaratilgan QR-kod`}</Heading>
<NextLink href="/"
passHref={true}><Link sx={{"color": "white", "fontSize": "20px", "textTransform": "uppercase", "backgroundColor": "black", "borderRadius": "7px", "padding": "10px"}}>{`Bosh sahifa`}</Link></NextLink>
